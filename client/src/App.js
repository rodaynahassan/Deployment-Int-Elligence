...
class App extends Component {
  ...
  setFormId = formId => {
    ...
    if (formId.status === "Unassigned")
      document.location.href = "/editUnassigned";
            ...
            <Router>
              <div>
                ...
                <Route
                  ...
                  path="/register"
                  render={props => (
                    <Register1 {...props} lang={this.state.lang} />
                  )}
                />
                <Route
                  exact
                ...
                <Route
                  exact
                  path="/dropDownGovernorate"
                  component={DropdownGovernorates}
                />
                <Route
                  exact
                  path="/unassignedForm"
                ...
                <Route
                  ...
                  path="/forgotPassword"
                  render={props => (
                    <ForgotPassword {...props} lang={this.state.lang} />
                  )}
                />
                ...
                <Route
                  exact
                  path="/createNewFormType"
                  render={props => (
                    <NewFormType {...props} lang={this.state.lang} />
                  )}
                />
                <Route
                  exact
                  path="/createNewFormTypeArray"
                  render={props => (
                    <NewFormTypeArray {...props} lang={this.state.lang} />
                  )}
                />
				 <Route
                  exact
                  ...
                  render={props => (
                    <NewDependency {...props} lang={this.state.lang} />
                  )}
                />
              </div>
