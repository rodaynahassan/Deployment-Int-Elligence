        ...
        return (
            ...
            <Card.Body>
               <div  style={{textAlign:'left'}}>
                ...
                <Button variant="outline-blue"  style={{width:"250px",height:"115px"}} onClick={()=>this.accept(this.props.company._id)} ><h3><i class="fas fa-handshake" style={{fontSize:'1em'}}></i> <br /> ACCEPT CASE</h3></Button> <br />
                <ButtonToolbar>
                    <Button
                ...
                <Button variant="outline-blue" block style={{width:"250px",height:"115px"}} onClick={()=>this.calculateFees(this.props.company._id)} ><h3><i class="fas fa-money-bill-alt" style={{fontSize:'1em'}}></i> <br /> Calculate The Fees</h3></Button>
                </ButtonGroup>
                </div>
                <br />
