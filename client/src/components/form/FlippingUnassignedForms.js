...
class FlippingUnassignedForms extends Component {
	AssignCase = (formId) => {
		...
		axios
			.put('/routes/api/users/takingForm/' + mongoose.Types.ObjectId(formId), {
		...
		return (
			...
			>
				...
				>
					...
					>
						{this.props.unassigned.companyName} <br /> <br />
						<br /> <br />
				...
				<BackSide style={{ backgroundColor: '#e8e6da', borderStyle: 'solid', borderWidth: '5px' }}>
					<div style={{ textAlign: 'center' }}>
						...
						Equity Capital : {this.props.unassigned.equityCapital}
						<br />
						Type : {this.props.unassigned.type}
						<br />
						Creation Date : {this.props.unassigned.creationDate}
						<br />
						<Button
							variant="nada"
							block
							onClick={() => (
								this.AssignCase(this.props.unassigned._id), alert('This Case is assigned to YOU!!')
							)}
						>
							<h3>PICK CASE</h3>
						</Button>
