									...
									<Table fixed>
										...
										<Table.Body>
											<Table.Row>
												...
												<Table.Cell>
													<span>{el.companyNameInEnglish}</span>
												</Table.Cell>
												<Table.Cell>
													<span>{el.companyGovernorate}</span>
												</Table.Cell>
												<Table.Cell>
													<span>{el.companyCity}</span>
												</Table.Cell>
												<Table.Cell>
													<span>{el.companyAddress}</span>
												</Table.Cell>
												<Table.Cell>
													<span>{el.companTelephone}</span>
												</Table.Cell>
												<Table.Cell>
													<span>{el.companyFax}</span>
												</Table.Cell>
												<Table.Cell>
													<span>{el.currency}</span>
												</Table.Cell>
												<Table.Cell>
													<span>{el.equityCapital}</span>
												</Table.Cell>
												<Table.Cell>
													<span>{el.type}</span>
												</Table.Cell>
