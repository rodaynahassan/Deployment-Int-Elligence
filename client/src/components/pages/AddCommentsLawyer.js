...
class AddCommentsLawyer extends Component {
	...
	handleClick = (formId, event) => {
		...
		var apiBaseUrl = '/routes/api/users/lawyerComments/' + mongoose.Types.ObjectId(formId);
		var payload = {
	...
	validateForm() {
		return this.state.lawyerComments.value.length >= 1;
	}
			...
			<div>
				<Modal {...this.props} size="lg" aria-labelledby="contained-modal-title-vcenter" centered>
					<Modal.Header closeButton>
						<Modal.Title id="contained-modal-title-vcenter">Add a Comment</Modal.Title>
					</Modal.Header>
					<Modal.Body>
						<input
							type="text"
							placeholder="Enter Your Comment"
							style={{ width: '775px', height: '100px' }}
