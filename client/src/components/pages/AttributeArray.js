...
class AttributeArray extends Component {
    ...
    componentDidMount = () => {
        axios.get('http://localhost:5000/routes/api/formTypes/getByFormTypeArray/' + localStorage.getItem('formTypeArray'), { headers: { "Authorization": localStorage.getItem('jwtToken') } })
            .then(res => {
    ...
    handleClick = (error) => {
       ...
       ///CHANGE THIS PART WITH THE NEW ROUTE
        ...
        var apiBaseUrl = "http://localhost:5000/routes/api/userDynamicForms/addAttributeToArray";
