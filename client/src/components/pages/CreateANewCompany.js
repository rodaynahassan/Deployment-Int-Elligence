...
class CreateANewCompany extends Component {
    ...
    componentDidMount = () => {
        ...
        axios.get('http://localhost:5000/routes/api/formTypes/getByFormType/' + localStorage.getItem('formType'), { headers: { "Authorization": localStorage.getItem('jwtToken') } })
            .then(res => {
                this.setState({
    ...
    changeHandler2 = event => {
        ...
        getArrayAtt = async (input) => {
            ...
            var arrConstraints = await axios.get('http://localhost:5000/routes/api/formTypes/getByFormTypeArray/' + input, { headers: { "Authorization": localStorage.getItem('jwtToken') } })
                .then(res => {
        ...
        handleClick = (error) => {
            ...
            var apiBaseUrl = "http://localhost:5000/routes/api/userDynamicForms/CreatingForm";

            ////console.log(payload2)


            axios.defaults.headers.common['Authorization'] = 'Bearer' + localStorage.getItem('jwtToken');
            axios.post(apiBaseUrl, payload2, { headers: { "Authorization": localStorage.getItem('jwtToken') } })
