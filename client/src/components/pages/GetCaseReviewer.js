...
class Companies extends Component {
  ...
  componentDidMount() {
    ...
    axios
      .get(
        "http://localhost:5000/routes/api/userDynamicForms/getReviewerInProgressCases",
  ...
  reject = formId => {
    ...
    axios
      .put(
        "http://localhost:5000/routes/api/userDynamicForms/reject/" +
          mongoose.Types.ObjectId(formId),
        { headers: { Authorization: localStorage.getItem("jwtToken") } }
      )
      .then(res => {
		...
		return (
			<div>
				<div>
					...
					>
						<h2 style={{ fontSize: '50px' }}>Specific Reviewer Cases</h2>
						<Dropdown>
