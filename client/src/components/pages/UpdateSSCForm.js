      ...
      validateForm() {
       // return this.state.companyName.value.length >=3 && this.state.companyName.value.length <=50 
        ...
        show(){
          ...
          x = x + 
          'Manager Name <br>' +
          '<input id = "Manager Name '+i+'" type="text" name="Manager Name" onkeypress=this.changeHandlerName; value='+this.state.SSCManagers[i].SSCManagerName+' > <br>' +
         ' Manager Type <br> '+
         '<input id = "Manager Type '+i+'" type="text" name="Manager Type" onkeypress=this.changeHandlerType; value='+this.state.SSCManagers[i].SSCManagerType+' > <br>'+
         ' Manager Gender <br> '+
         '<input id = "Manager Gender '+i+'" type="text" name="Manager Gender" onkeypress=this.changeHandlerGender; value='+this.state.SSCManagers[i].SSCManagerGender+' > <br>'+
         ' Manager Nationality <br> '+
         '<input id = "Manager Nationality '+i+'" type="text" name="Manager Nationality" onkeypress=this.changeHandlerNationality; value='+this.state.SSCManagers[i].SSCManagerNationality+' > <br>'+
         ' Manager IdentificationType <br> '+
         '<input id = "Manager IdentificationType '+i+'" type="text" name="Manager IdentificationType" onkeypress=this.changeHandlerIdentificationType; value='+this.state.SSCManagers[i].SSCManagerIdentificationType+' > <br>'+
         ' Manager IdentificationNumber <br> '+
         '<input id = "Manager IdentificationNumber '+i+'" type="text" name="Manager IdentificationNumber" onkeypress=this.changeHandlerIdentificationNumber; value='+this.state.SSCManagers[i].SSCManagerIdentificationNumber+' > <br>'+
         ' Manager Birthdate <br> '+
         '<input id = "Manager Birthdate '+i+'" type="text" name="Manager Birthdate" onkeypress=this.changeHandlerBirthdate; value='+this.state.SSCManagers[i].SSCManagerBirthdate+' > <br>'+
         ' Manager Address <br> '+
         '<input id = "Manager Address '+i+'" type="text" name="Manager Address" onkeypress=this.changeHandlerAddress; value='+this.state.SSCManagers[i].SSCManagerAddress+' > <br>'+
         ' Manager ManagerialType <br> '+
         '<input id = "Manager ManagerialType '+i+'" type="text" name="Manager ManagerialType" onkeypress=this.changeHandlerManagerialType; value='+this.state.SSCManagers[i].typeOfManagers +' > <br>'
