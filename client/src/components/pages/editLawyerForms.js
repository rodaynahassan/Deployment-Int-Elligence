...
class editLawyerForms extends Component {
    constructor(props) {
        super(props);
        this.state = {
            attributes: [],
    ...
    changeHandler2 = event => {
        ...
        handleClick = (error) => {
            ...
            var apiBaseUrl = "/routes/api/userDynamicForms/lawyerEditForm/"+localStorage.getItem('formId')
            ...
            axios.put(apiBaseUrl, payload2, { headers: { "Authorization": localStorage.getItem('jwtToken') } })
                .then(function (response) {
                    ...
                    swal('The Form has been updated successfully');
   ...
   const style = {
    ...
    export default editLawyerForms;